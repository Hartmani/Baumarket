...
export default function PorothermPage() {
      ...
      <main style={page}>
        ...
        <div style={card}>
          ...
          <p style={successText}>
            ...
            Vaše poptávka byla zařazena do hromadného nákupu Porothermu.
  ...
  return (
    ...
    <main style={page}>
      ...
      <div style={card}>
        ...
        <h1 style={title}>🧱 Porotherm</h1>

        <p style={subtitle}>

          Připojte se k hromadné objednávce cihel Porotherm a získejte lepší cenu díky většímu objemu nákupu.
