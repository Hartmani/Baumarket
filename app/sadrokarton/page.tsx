      ...
      <main style={page}>
        ...
        <div style={card}>
          ...
          <p style={successText}>
            ...
            Vaše poptávka byla zařazena do hromadného nákupu sádrokartonu.
  ...
  return (
    ...
    <main style={page}>
      ...
      <div style={card}>
        ...
        <h1 style={title}>📐 Sádrokarton</h1>

        <p style={subtitle}>

          Připojte se k hromadné objednávce sádrokartonových desek, profilů,

          tmelů a dalšího příslušenství.
        ...
        <div style={form}>
          ...
          <textarea
            ...
            placeholder="Typ desek, profily, příslušenství nebo poznámka"
